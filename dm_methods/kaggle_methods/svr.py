...
class SVR_CV(learning_methods.learning_methods):
    def __init__(self,x,y,metric,scoring='neg_log_loss',n_jobs=2,save_model=False):
        super(SVR_CV,self).__init__(x,y,metric,scoring=scoring,save_model=save_model)
