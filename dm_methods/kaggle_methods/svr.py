...
class SVR_CV(learning_methods.learning_methods):
    def __init__(self,x,y,metric,scoring='neg_log_loss',save_model=False):
        super(SVR_CV,self).__init__(x,y,metric,scoring=scoring,n_jobs=2,save_model=save_model)
        #default kernel is rbf
        self.model = SVR(C = 1.0,probability=True)
        self.n_jobs = n_jobs
