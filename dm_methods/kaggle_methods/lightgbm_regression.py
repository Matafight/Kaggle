...
'''
class lightgbmRegression_CV:
    def __init__(self,x,y,metric,metric_name='l2',scoring = 'neg_mean_squared_error'):
        self.x = x
        self.y = y
        #use default values
    ...
    def modelfit(self):
        ...
        self.train_scores.append(self.metric(self.y,self.model.predict(self.x)))
